...
AI layer Vitest sub-agent for proto_scribe. Runs tests in `src/lib/ai/`, classifies failures, proposes diffs, and reports untested functions. Invoked via `/ai-test`.
